                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" id="telnum" name="telnum" placeholder="Tel. No." value={this.state.telnum} onChange={this.handleInputChange}/>
                                </Col>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" placeholder="Feedback here..." rows="12" value={this.state.message} onChange={this.handleInputChange}/>
                                </Col>
                            </FormGroup>
